...
#    fig, ax = plt.subplots(figsize=(12, 6), subplot_kw={'projection': proj})
    ...
    AR_mask = AR_shape['shapemap'].sel(time=date).fillna(0)[0]

    ax.contour(AR_mask.lon, AR_mask.lat, AR_mask.values, levels=[0.5], 
    ...
    fig.savefig(f"fig/HWs_ARs_G_{date}.png", dpi = 300, facecolor='w', bbox_inches = 'tight', pad_inches = 0.1)

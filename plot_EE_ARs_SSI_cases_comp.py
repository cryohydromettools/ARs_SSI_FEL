...
levels_z500 = [lev for lev in np.arange(-200, 200, 25) if lev != 0]  # Exclude zero
...
levels_precip = np.arange(0, 6.1, 0.25)
...
# --- Title ---
ax.set_title(f"IVT mean (shaded) and IVT Vectors (u,v)")

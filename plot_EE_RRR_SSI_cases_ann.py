...
AR_shape = xr.concat(ds_list, dim='time')
dates = ['1998-11-16', '1999-02-11', '1999-02-21', '1999-11-16', '2004-11-30', '2005-02-12', '2006-11-11']
HWs_ARS_KJS_just = pd.DataFrame({'date': pd.to_datetime(dates)})
